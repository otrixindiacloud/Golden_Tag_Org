              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-3"
                  />
                  <span className="text-gray-700">Express Shipping (1-2 business days) - ₹199</span>
                </label>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">Golden Tag - Checkout</h1>
